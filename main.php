<div class="content">
            <div class="container-fluid">
                ...
                <!--Bich wala kachra which shows Recent Fees Collections-->
                <!--row begins-->
                    <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                        ...
                        <div class="card">
                            <div class="content">
                                <div class="row">
                                    ...
                                    <div class="col-xs-7">
                                        <div class="numbers">
                                            <p><strong>Student Types</strong></p>
            ...
            <div class="container-fluid">
                <nav class="pull-left">
                    <ul>
                        ...
                        <li>
                            <a href="http://localhost/fantasticschooladmin/">
                        ...
                        <li>
                            <a href="mailto:hasanabbasofficial@gmail.com?subject=From website:">
                                <strong>Admin</strong>
                            </a>
                        </li>
                        <li>
                            <a href="tel:+917460079494">
                                <strong>Call us at 74******94</strong>
                            </a>
                        </li>
                    </ul>
                </nav>
                <div class="copyright pull-right">
                    &copy; <script>document.write(new Date().getFullYear())</script>, made with &nbsp;<i class="ti-heart heart"></i> &nbsp;by <a href="https://instagram.com/bhuu_._?igshid=YmMyMTA2M2Y=">Bhoomika,</a><a href="https://instagram.com/prince.shr01?igshid=YmMyMTA2M2Y="> Kishan, </a><a href="https://instagram.com/hasanabbasofficial_?igshid=YmMyMTA2M2Y="> Hasan</a>
                </div>
            </div>
        </footer>
